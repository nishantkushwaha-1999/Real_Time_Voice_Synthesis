...
class WaveRNN(nn.Module):
    ...
    def forward(self, x, mels):
        ...
        #     h1 = torch.zeros(1, bsize, self.rnn_dims).to("mps")
        #     h2 = torch.zeros(1, bsize, self.rnn_dims).to("mps")
        else:
    ...
    def generate(self, mels, batched, target, overlap, mu_law, progress_callback=None):
        ...
        with torch.no_grad():
            ...
            # elif torch.backends.mps.is_available():
            #     h1 = torch.zeros(b_size, self.rnn_dims).to("mps")
            #     h2 = torch.zeros(b_size, self.rnn_dims).to("mps")
            #     x = torch.zeros(b_size, 1).to("mps")
            else:
    ...
    def pad_tensor(self, x, pad, side='both'):
        ...
        #     padded = torch.zeros(b, total, c).to("mps")
        else:
    ...
    def fold_with_overlap(self, x, target, overlap):
        ...
        # if torch.backends.mps.is_available():
        #     folded = torch.zeros(num_folds, target + 2 * overlap, features).to("mps")
        else:
